    ...
    <section id="subscribe" className="py-24 bg-gradient-egyptian">
      <div className="container mx-auto px-4 text-center max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="flex gap-3">
          ...
          <button
            type="submit"
            className="bg-accent font-heading font-semibold text-xs tracking-widest uppercase px-6 py-3 rounded-sm glow-green hover:opacity-90 transition-opacity border border-accent/30 text-white"
          >
            Subscribe
          </button>
        </form>
