...
const statusConfig = {
  completed: {
    ...
    dot: "bg-accent",
    glow: "glass-emerald",
    badge: { bg: "hsl(162 55% 48% / 0.12)", border: "hsl(162 55% 48% / 0.35)", color: "hsl(162 65% 65%)" },
    numColor: "hsl(162 55% 48% / 0.12)",
  ...
  active: {
    ...
    glow: "glass-gold",
    badge: { bg: "hsl(43 78% 62% / 0.12)", border: "hsl(43 78% 62% / 0.4)", color: "hsl(43 85% 72%)" },
    numColor: "hsl(43 78% 62% / 0.10)",
  ...
  upcoming: {
    ...
    glow: "glass",
    badge: { bg: "hsl(0 0% 100% / 0.05)", border: "hsl(0 0% 100% / 0.12)", color: "hsl(0 0% 65%)" },
    numColor: "hsl(0 0% 100% / 0.04)",
