      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <ScrollReveal variant="scaleUp" delay={0.1}>
          <div className="max-w-3xl mx-auto mb-12">
            <StaggerContainer className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4" staggerDelay={0.08}>
              {steps.map((s) => (
                <StaggerItem key={s.label}>
                  <div className="glass-gold rounded-2xl p-4 sm:p-5 flex flex-col items-center text-center gap-2 sm:gap-3 hover:border-primary/40 hover:-translate-y-0.5 transition-all duration-200 glow-card h-full">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-6" staggerDelay={0.15}>
            {[
              ...
              <StaggerItem key={c.title}>
                <div className={`rounded-2xl p-5 sm:p-7 glow-card h-full ${c.emerald ? "glass-emerald" : "glass-gold"}`}>
